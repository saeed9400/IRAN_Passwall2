...
| 📌 ویژگی‌ها | 📦 v1 | 🚀 v2 |
|:-----------|:-----:|:-----:|
| 🌍 مناسب برای | اینترنت پایدار | اینترنت ایران |
| 📥 منبع نصب | مخازن رسمی | رسمی + فال‌بک |
| 🔍 بررسی اتصال | پایه | چندلایه |
| 🔀 تفکیک ترافیک | استاندارد | مقاوم |
| 📊 وضعیت | ✅ پایدار | 🚧 توسعه |
| 🔗 دسترسی | [مشاهده v1](https://github.com/saeed9400/IRAN_Passwall2/tree/main/v1) | [مشاهده v2](https://github.com/saeed9400/IRAN_Passwall2/tree/main/v2) |
